        ...
        <ModalContent>
          ...
          <ModalBody className="space-y-3">
            <div className="text-small text-default-500">
              每台机器一条订阅(直连 / 中转各一条)。发对应的一条给车友:v2rayN →
              订阅 → 添加 → 粘贴 → 更新。
            </div>
              ...
              <div className="border border-primary/40 bg-primary/5 rounded-lg p-3 space-y-2">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <Chip size="sm" variant="flat">
                    {subLines.reduce(
                      (n: number, l: any) => n + (l.protocolCount || 0),
                      0,
                    )}{" "}
                    协议
                  </Chip>
...
这一步不可逆,以后要再给他用得重新分配。`)
          ...
          <ModalFooter>
            <Button variant="light" onPress={onSubModalClose}>
              关闭
            </Button>
          </ModalFooter>
        </ModalContent>
