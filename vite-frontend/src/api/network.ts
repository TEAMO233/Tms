...
const SLOW_PATHS = [
  ...
  "/inbound/udp-quic-relay",
  "/inbound/delete-by-node",
  "/landing/test",
  "/node/install",
  "/forward/create",
  "/forward/update",
  "/transparent-relay/create",
  "/transparent-relay/batch-create",
  "/transparent-relay/update",
  "/transparent-relay/delete",
  "/transparent-relay/pause",
  "/transparent-relay/resume",
  "/transparent-relay/status",
  "/tunnel/diagnose",
  "/forward/diagnose",
];
